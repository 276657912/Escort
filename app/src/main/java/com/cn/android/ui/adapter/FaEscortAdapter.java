 ...
 *    desc   : 可进行拷贝的副本
 */
public final class FaEscortAdapter extends BaseQuickAdapter<MyEscortBean, BaseViewHolder> {
    ...
    public FaEscortAdapter(Context context) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, MyEscortBean item) {
