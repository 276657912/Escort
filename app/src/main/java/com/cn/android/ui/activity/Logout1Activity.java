 ...
 * desc   : 可进行拷贝的副本
 */
public final class Logout1Activity extends MyActivity implements PublicInterfaceView {
    ...
    protected int getLayoutId() {
        return R.layout.activity_logout1;
    }
    ...
    public void onPublicInterfaceSuccess(int code, String data, String msg, int tag) {
        ...
        startActivity(Logout2Activity.class);
        this.finish();
    }
